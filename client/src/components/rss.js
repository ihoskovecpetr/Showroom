...
renderAkciSekce() {
    ...
    if (!this.state.isLoaded) {
            return (  
                <Button bsStyle="info" >Čekejte prosím</Button>
                );
        }             
        return (
                <Button bsStyle="success" >RSS feed Načten</Button>
                );
}

  render() {

    console.log(" Jen jeden SRC " + this.state.img[1] + " Jen jeden SRC " )
    console.log(" Title " + this.state.users[1] + " Title" )
    return (
